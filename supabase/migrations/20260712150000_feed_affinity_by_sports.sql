-- Substitui o critério de afinidade da descoberta de feed: em vez de agrupar
-- creators pela mesma creator_profiles.category (texto livre, sem taxonomia
-- fixa), passa a usar interseção de creator_profiles.sports — a mesma
-- taxonomia já usada no filtro direto por esporte. category deixa de ter
-- qualquer efeito no app; a coluna continua existindo no banco.
